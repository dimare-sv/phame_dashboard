...
export const LAYER_SPECS: LayerSpec[] = [
  ...
  /* ================================ 07 재무 ================================ */
  {
    ...
    extras: [
      ...
      {
        /* 비용이 한 줄도 없으면 "성장 중" 과 "돈 태우며 성장 중" 을 구분할 수 없다.
           광고비는 GA4 에도 DB 에도 없다 — 밖(메타·구글 광고)에 있다. 그래서 미연동으로 둔다. */
        title: "단위 경제",
        ...
        rows: [
          ...
          ["CAC (획득 비용)", null, null, null],
        ],
        footnote:
          "<b>CAC 와 회수 기간은 광고비가 있어야 계산됩니다.</b> 광고비는 GA4 에도 DB 에도 없고 " +
          "메타·구글 광고 계정에 있습니다 — 연동 전까지는 <b>측정 불가(—)</b>로 둡니다. " +
          "0 으로 채우면 LTV:CAC 가 무한대로 보여 <b>가장 위험한 착시</b>가 생깁니다. " +
          "회수 기간도 같은 이유로 아직 못 냅니다. 초기에는 월 1회 수기 입력으로 시작해도 됩니다.",
      },
    ],
  },
